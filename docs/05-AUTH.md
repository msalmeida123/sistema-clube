...
| Módulo | Relação |
|--------|---------|
| **Todos os módulos** | Controle de acesso a todas as funcionalidades |
| **Configurações** | Gestão de perfis e páginas do sistema |
...
5. Tentativas de login são limitadas (rate limiting do Supabase)
6. Rotas são protegidas via middleware Next.js
7. Permissões CRUD são granulares por página do sistema
