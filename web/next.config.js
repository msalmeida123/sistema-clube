    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              `script-src 'self' 'unsafe-inline' 'unsafe-eval'${__impeccableLiveDev}`, // Next.js precisa
              ...
              "font-src 'self' data:",
              `connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.wasenderapi.com https://www.wasenderapi.com https://api.openai.com${__impeccableLiveDev}`,
