...
function ConfiguracaoCores({onSave}:{onSave:(c:Cores)=>void}){
 ...
 return <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4 clube-modal-overlay"><div role="dialog" aria-modal="true" aria-label="Configurar cores dos serviços" className="bg-white rounded-xl p-6 w-full max-w-lg space-y-4 max-h-[90vh] overflow-auto">
